...
module.exports = sitemap, Sitemap.prototype.generate = function(app, router, store) {
    ...
    this.my.head ? head += this.my.head : head += '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">';
    var langFlag = !1, data = "";
    for (var uri in sitemap) {
        ...
        if ((!1 === hideByRegex || !hideByRegex(uri)) && (!rr || !rr.disallow && !rr.hide)) {
            ...
            rr.image && (data += "<image:image><image:loc>" + rr.image + "</image:loc></image:image>"), 
            rr.alternatepages)) {
                langFlag = !0;
